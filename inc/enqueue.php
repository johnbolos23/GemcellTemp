...
if (!function_exists('understrap_scripts')) {
	...
	function understrap_scripts()
	{
		...
		wp_enqueue_script( 'googlemapapi', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyAEPh1fe1kgVloGScUKPpxhlyzG1j5gsX8&libraries=places', array('jquery'), true, true);  
