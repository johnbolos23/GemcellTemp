...
function cptui_register_my_cpts() {
	...
	$labels = [
		"name" => esc_html__( "Members", "gemcell" ),
		"singular_name" => esc_html__( "Member", "gemcell" ),
		"menu_name" => esc_html__( "Members", "gemcell" ),
		"all_items" => esc_html__( "All Members", "gemcell" ),
		"add_new" => esc_html__( "Add new", "gemcell" ),
		"add_new_item" => esc_html__( "Add new Member", "gemcell" ),
		"edit_item" => esc_html__( "Edit Member", "gemcell" ),
		"new_item" => esc_html__( "New Member", "gemcell" ),
		"view_item" => esc_html__( "View Member", "gemcell" ),
		"view_items" => esc_html__( "View Members", "gemcell" ),
		"search_items" => esc_html__( "Search Members", "gemcell" ),
		"not_found" => esc_html__( "No Members found", "gemcell" ),
		"not_found_in_trash" => esc_html__( "No Members found in trash", "gemcell" ),
		"parent" => esc_html__( "Parent Member:", "gemcell" ),
		"featured_image" => esc_html__( "Featured image for this Member", "gemcell" ),
		"set_featured_image" => esc_html__( "Set featured image for this Member", "gemcell" ),
		"remove_featured_image" => esc_html__( "Remove featured image for this Member", "gemcell" ),
		"use_featured_image" => esc_html__( "Use as featured image for this Member", "gemcell" ),
		"archives" => esc_html__( "Member archives", "gemcell" ),
		"insert_into_item" => esc_html__( "Insert into Member", "gemcell" ),
		"uploaded_to_this_item" => esc_html__( "Upload to this Member", "gemcell" ),
		"filter_items_list" => esc_html__( "Filter Members list", "gemcell" ),
		"items_list_navigation" => esc_html__( "Members list navigation", "gemcell" ),
		"items_list" => esc_html__( "Members list", "gemcell" ),
		"attributes" => esc_html__( "Members attributes", "gemcell" ),
		"name_admin_bar" => esc_html__( "Member", "gemcell" ),
		"item_published" => esc_html__( "Member published", "gemcell" ),
		"item_published_privately" => esc_html__( "Member published privately.", "gemcell" ),
		"item_reverted_to_draft" => esc_html__( "Member reverted to draft.", "gemcell" ),
		"item_scheduled" => esc_html__( "Member scheduled", "gemcell" ),
		"item_updated" => esc_html__( "Member updated.", "gemcell" ),
		"parent_item_colon" => esc_html__( "Parent Member:", "gemcell" ),
	];

	$args = [
		"label" => esc_html__( "Members", "gemcell" ),
		"labels" => $labels,
		"description" => "",
		"public" => true,
		"publicly_queryable" => true,
